...
public class Orb : MonoBehaviour
{
    ...
    private DecalPoolController decalPool;
    ...
    protected virtual void Start()
	{
        ...
        ZFighting = GameObject.Find("[DecalPool]").GetComponent<ZFighting>();
        decalPool = GameObject.Find("[DecalPool]").GetComponent<DecalPoolController>();
	}
